  ...
  return (
    <div>
        <div className="p-[.5vh] md:p-[.5vw] lg:p-[.5vw] relative rounded-xl bg-gradient-to-b from-zinc-100 to-green-200">
            <ImageKit src={'https://ik.imagekit.io/8jagcyqun/default-image.jpg?updatedAt=1747192787254'} alt="About" className="w-full h-[18vh] md:w-full md:h-[15vw] lg:w-full lg:h-[16vw] rounded-xl object-cover" w={700} h={700} />
